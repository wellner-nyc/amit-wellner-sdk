...
namespace TheOneSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Movies :  IEquatable<Movies>
    {
        /// <summary>
        ...
        public Movies(List<Docs> Docs = null, int? Limit = null, int? Offset = null, int? Page = null, int? Pages = null, int? Total = null)
        {
            // to ensure "Docs" is required (not null)
            if (Docs == null)
            {
                throw new InvalidDataException("Docs is a required property for Movies and cannot be null");
            }
            else
            {
                this.Docs = Docs;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Movies);
        }

        /// <summary>
        /// Returns true if Movies instances are equal
        /// </summary>
        /// <param name="other">Instance of Movies to be compared</param>
        /// <returns>Boolean</returns>
