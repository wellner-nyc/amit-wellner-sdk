...
namespace TheOneSDK.Model
{
    ...
    public partial class Quote :  IEquatable<Quote>
    {
        ...
        public Quote(List<string> Docs = null, int? Limit = null, int? Offset = null, int? Page = null, int? Pages = null, int? Total = null)
        {
            // to ensure "Docs" is required (not null)
            if (Docs == null)
            {
                throw new InvalidDataException("Docs is a required property for Quote and cannot be null");
            }
            else
            {
                this.Docs = Docs;
